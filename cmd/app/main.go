...
import (
	...
	"eth-contract-service/internal/global"
	"eth-contract-service/provider/logger"
...
// Example: go build -ldflags "-X main.Version=x.y.z -X main.Name=eth-contract-service"
var (
