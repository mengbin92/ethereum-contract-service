...
contract ERC20TokenOwnable is ERC20, Ownable {
     ...
     * @param owner_ 初始代币接收地址和合约所有者（通常是部署者地址）
     */
    constructor(
        string memory name_,
        ...
        require(owner_ != address(0), "ERC20TokenOwnable: owner cannot be zero address");
        require(decimals_ > 0 && decimals_ <= 18, "ERC20TokenOwnable: decimals must be between 1 and 18");
    ...
    function mint(address to, uint256 amount) public onlyOwner {
        require(to != address(0), "ERC20TokenOwnable: cannot mint to zero address");
        _mint(to, amount);
    }
